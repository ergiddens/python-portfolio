...
```
    ...
    Enter the name of the input RNA file:  gene_rna.txt
...
```
    ...
    Enter the name of the output file:  gene_protein.txt
...
```
    ...
    Protein sequence has been saved to gene_protein.txt
